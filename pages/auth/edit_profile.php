              ...
              <div class="row justify-content-center align-items-center g-2">
                <div class="col-8">
                  ...
                  <div class="form-floating mb-3">
                    <input
                      type="text"
                      class="form-control" name="fname" placeholder="f" value="<?php echo $userInfo['first_name'];?>">
                    <label for="fname">First Name</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input
                      type="text"
                      class="form-control" name="lname" placeholder="l" value="<?php echo $userInfo['last_name'];?>">
                    <label for="lname">Last Name</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input
                      type="email"
                      class="form-control" name="email" placeholder="e" value="<?php echo $userInfo['email'];?>">
                    <label for="email">Email</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input
                      type="number"
                      class="form-control" name="age" placeholder="e" min="1" max="100" value="<?php echo $userInfo['age'];?>">
                    <label for="age">Age</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input
                      type="text"
                      class="form-control" name="country" placeholder="e" value="<?php echo $userInfo['country'];?>">
