...
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (1, 1010, 'test.txt', 20, 16, 1, 23, 49, '2022-07-31 21:43:16');
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (2, 1003, 'test.txt', 17, 15, 6, 89, 90, '2022-05-09 21:57:00');
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (3, 1005, 'test.txt', 6, 14, 5, 98, 22, '2022-09-07 14:32:42');
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (4, 1003, 'test.txt', 16, 10, 11, 66, 12, '2021-12-02 09:28:22');
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (5, 1001, 'test.txt', 14, 11, 10, 6, 76, '2022-10-01 20:46:50');
insert into article_table (id, user_id, content_path, genre_id_01, genre_id_02, genre_id_03, likes, stores, datetime) values (6, 1010, 'test.txt', 12, 10, 11, 25, 77, '2022-12-11 03:22:14');
